...
$prestador_empresa = 'Sapataria Xing Ling';
$prestador_nome = 'Carlos';
$prestador_endereco = 'Rua general camara 5555';
$prestador_telefone = '51-99999999';
$prestador_img = 'https://image.shutterstock.com/image-vector/shoe-repair-mens-shoes-hammer-600w-418110376.jpg';
$id_prestador = 1;
$descricao = 'Preciso arrumar um sapato que está com problema na sola que fica descolando.';
$cliente_nome = 'Luck';


//Email que o prestador recebe
$template_prestador = '
<tr>
<td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
  <div class="text">
	  <h2>'.$cliente_nome.'Solicitou seu contato para um serviço</h2>
  </div>
</td>
</tr>
<tr>
<td>
	<div class="text-author" style="bordeR: 1px solid rgba(0,0,0,.05);max-width: 50%;margin: 0 auto;padding: 2em;">
		...
		<h3 class="name">Cliente: '.$cliente_nome.'</h3>
		<span class="position" style="color:black; text-align:left">
		Descrição:<br><br>
		'.$descricao.'
	  </span>
	  <div style="text-align:center" >
		 <p><a href="#" class="btn btn-primary" style="border-radius: 5px;background: #17bebb;color: #ffffff; padding: 10px 15px; display: inline-block;">Aceitar</a></p>
		 <p><a href="#" style="border-radius: 5px;background: #dc3545; color: #ffffff; padding: 10px 15px; display: inline-block;">Recusar</a></p>
		 </div>
	 </div>
</td>';
...
<td style="padding: 0 2.5em; text-align: center; padding-bottom: 3em;">
	<div class="text">
		<h2 style="color: #000;	font-size: 34px;	margin-bottom: 0;	font-weight: 200; line-height: 1.4;"><?= $nome_user ?> Enviou os dados de contato para você.</h2>
	</div>
</td>
</tr>
<tr>
...
<td>
	  <div class="text-author" style="bordeR: 1px solid rgba(0,0,0,.05);max-width: 50%;margin: 0 auto;padding: 2em;" >
		...
		<img src="'.$prestador_img.'" alt="" style="width: 100px; max-width: 600px; height: auto; margin: auto; display: block;">
		  <h3 class="name" style="font-size:22px; color:#213b52">'.$prestador_empresa.'</h3><br>
		</div>
		<div style="text-align: left; color:black; font-size:16px">
		  <span class="position"><b style="color:#213b52">Nome do prestador:</b> '.$prestador_nome.'</span><br>
		<span class="position"><b style="color:#213b52">Telefone: </b>'.$prestador_telefone.'</span><br>
		<span class="position"><b style="color:#213b52">Endereço:</b> '.$prestador_endereco.'</span><br><br>
		<a href="https://www.google.com/maps/search/'.$prestador_endereco.'" style="color:green" >Ver no mapa</a><br>
